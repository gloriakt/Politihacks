...
<div class="addbuttonaction actionspan" style="display:none;position:absolute;top:60px;left:300px;width:auto!important;">
...
<div class="column1action actionspan" style="display:none;position:absolute;top:50px;left:300px;width: 500px;">
<div class="actionhelper"></div>
...
<div class="column2action actionspan" style="display:none;position:absolute;top:50px;left:300px;width: 500px;">
<div class="actionhelper"></div>
...
<div class="column3action actionspan" style="display:none;position:absolute;top:50px;left:300px;">
<div class="actionhelper"></div>
...
<div class="actionheader"><input type="button" class="close actionbutton" value=""><input type="button" class="resetbutton actionbutton" value="Reset"><input type="button" class="column3submit actionbutton" value="ADD"><p class="actiontitle">Add 3 Columns</p></div>
    ...
    <div class="column4action actionspan" style="display:none;position:absolute;top:50px;left:300px;">
<div class="actionhelper"></div>
<span style="float:left;">
<h1>First cell</h1>
...
<div class="h1h2action actionspan" style="display:none;position:absolute;top:70px;left:300px;width: 600px;">
<div class="actionhelper"></div>
...
<div class="calltoaction actionspan" style="display:none;position:absolute;top:70px;left:300px;width:700px;height: 300px;">
<div class="actionhelper"></div>
