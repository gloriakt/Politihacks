        ...
        <div class="wrapper">
            <div class="content-wrap-left left">
                ...
                <div class="blog-content left">
                    ...
                    <div class="blog-images left"><a  href="<?php echo get_permalink(); ?>"><img src="<?php echo get_template_directory_uri();?>/script/timthumb.php?src=<?php print $post_img;?>&w=248&h=138&zc=1&q=100" alt="_" title="<?php the_title();?>" /></a></div>
