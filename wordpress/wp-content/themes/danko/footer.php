				...
				?>	
                    <div class="home-blog-one left">
                     ...
                     <div class="home-blog-images left">
                       <a href="<?php echo get_permalink(); ?>"> <img src="<?php echo get_template_directory_uri();?>/script/timthumb.php?src=<?php print $img;?>&w=168&h=168&zc=1&q=100"  alt=""  title="<?php the_title();?>" /></a>
                     </div>
                        ...
                        <div class="home-blog-text left">
                            ...
                            <span><?php echo get_the_date();?>  | <a class="comment-foot" href="<?php echo get_permalink(); ?>"><?php if ($num_of_comments == 0){echo '0';} else {echo $num_of_comments;} ?> <?php _e('comments', tk_theme_name); ?></a></span>
