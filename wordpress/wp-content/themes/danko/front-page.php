...
<div class="slider-content left"> 
            ...
            <div class="form-fields">
        	  <div class="signup-form">   
        			<form action="http://politihacks.us6.list-manage1.com/subscribe/post?u=c0d2120f033f39dc48e6f2420&amp;id=4ba7391186" method="post" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
         		 		<label for="usr_email">
          				</label>
          				<input id="email" value"" name="EMAIL"class="email" id="mce-EMAIL" placeholder="email address" required ></span>
          		</div>
          		<div class="subscribeButton"><input type="submit" value="Subscribe" name="subscribe" class="btn btn-primary"></div>
      			  </form>
      			  </div>
